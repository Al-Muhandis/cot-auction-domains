...
CREATE TABLE IF NOT EXISTS `cot_sbr` (
  ...
  `sbr_employer` int(11) NOT NULL,  /* === Добавлено === */
  `sbr_broker` int(11) NOT NULL default '0',     /* ===== */
  `sbr_title` varchar(255) collate utf8_unicode_ci NOT NULL, 
  `sbr_cost` float(16,2) NOT NULL,
  `sbr_tax` float(16,2) NOT NULL,/* === Добавлено === */
  `sbr_taxpayer` int(11) NOT NULL,  
  `sbr_atax` float(16,2) NOT NULL, /* ===== */ 
