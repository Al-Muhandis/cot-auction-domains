...
$L['cfg_tax'] = array('Комиссия за оформление сделки c Покупателя (%)');
$L['cfg_tax_performer'] = array('Комиссия с Продавца (%)');
...
$L['sbr_performer_placeholder'] = 'Введите логин продавца';
...
$L['sbr_stage_done_payments_desc'] = 'СБР: "{$sbr_title}": Оплата за домен №{$stage_num} ({$stage_title}).';
