...
function cot_generate_sbrtags($item_data, $tag_prefix = '', $admin_rights = null, $pagepath_home = false)
{
    ...
    switch ($item_data['sbr_taxpayer']) 
    {
      case 0:  $ETotal = $item_data['sbr_cost'] + $item_data['sbr_tax']; break;
      case 1:  $ETotal = 0; break;
      case 2:  $ETotal = $item_data['sbr_cost'] + $item_data['sbr_tax']/2; break;
      default: $ETotal = $item_data['sbr_cost'] + $item_data['sbr_tax']; break;
    }
    switch ($item_data['sbr_taxpayer']) 
    {
      case 0:  $PSumm = $item_data['sbr_cost'] - $item_data['sbr_atax']; break;
      case 1:  $PSumm = $item_data['sbr_cost'] - $item_data['sbr_tax'] - $item_data['sbr_atax']; break;
      case 2:  $PSumm = $PSumm = $item_data['sbr_cost'] - $item_data['sbr_tax']/2 - $item_data['sbr_atax']; break;
      default: $PSumm = $item_data['sbr_cost'] - $item_data['sbr_atax']; break;
    }    
		$temp_array = array(
			'ID' => $item_data['sbr_id'],
      ...
      'TAXPAYER' => $item_data['sbr_taxpayer'],      
			'ATAX' => $item_data['sbr_atax'],      
			'TOTAL' => $ETotal,
      'PERFORMERSUMM' => $PSumm,
